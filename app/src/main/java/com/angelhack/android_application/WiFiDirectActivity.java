...
public class WiFiDirectActivity extends Activity implements ChannelListener {
    ...
    public void onResume() {
        super.onResume();
        receiver = new WiFiDirectBroadcastReceiver(Global.manager, Global.channel, this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.atn_direct_enable:
                if (Global.manager != null && Global.channel != null) {
            ...
            case R.id.atn_direct_discover:
                ...
                Global.manager.discoverPeers(Global.channel, new ActionListener() {
...
//        fragment.showDetails(device);
    ...
    public void connect(WifiP2pConfig config) {
        Global.manager.connect(Global.channel, config, new ActionListener() {
    ...
    public void disconnect() {
        final DeviceDetailFragment fragment = (DeviceDetailFragment) getFragmentManager()
                .findFragmentById(R.id.frag_detail);
        fragment.resetViews();
        Global.manager.removeGroup(Global.channel, new ActionListener() {
    ...
    public void onChannelDisconnected() {
        if (Global.manager != null && !retryChannel) {
            Toast.makeText(this, "Channel lost. Trying again", Toast.LENGTH_LONG).show();
            resetData();
            retryChannel = true;
            Global.manager.initialize(this, getMainLooper(), this);
        } else {
            Toast.makeText(this,
    ...
    public void cancelDisconnect() {
        if (Global.manager != null) {
            ...
            if (fragment.getDevice() == null
                ...
                Global.manager.cancelConnect(Global.channel, new ActionListener() {
