...
public class MainActivity extends AppCompatActivity implements WifiP2pManager.ConnectionInfoListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        device = (WifiP2pDevice) getIntent().getParcelableExtra("device");
...
////        intent.putExtra("foo", "com.angelhack.android_application.SEND_FILE");
//
//        Log.e("deviceAddress", device.deviceAddress);
//        Log.e("deviceAddress", device.deviceName);
//        Log.e("deviceAddress", device.primaryDeviceType);
//
//        Log.e("deviceAddress", "" + device.describeContents());
////        Log.e("deviceAddress", device.secondaryDeviceType);
//        Log.e("deviceAddress", ""+ device.isGroupOwner());
//
//        startService(intent);
...
//                       cancelDisconnect();
        ...
        btn_start_client.setOnClickListener(
                new View.OnClickListener() {
    ...
    public void cancelDisconnect() {
        ...
        if (Global.manager != null) {
            ...
            if (fragment.getDevice() == null
                ...
                Global.manager.cancelConnect(Global.channel, new WifiP2pManager.ActionListener() {
...
//        setVisibility(View.VISIBLE);
        ...
        if (info.groupFormed && info.isGroupOwner) {
            new DeviceDetailFragment.FileServerAsyncTask(MainActivity.this, findViewById(R.id.status_text))
                    .execute();
        } else if (info.groupFormed) {
            // The other device acts as the client. In this case, we enable the
            // get file button.
            findViewById(R.id.btn_start_client).setVisibility(View.VISIBLE);
            ((TextView) findViewById(R.id.status_text)).setText(getResources()
...
//        this.getView().setVisibility(View.VISIBLE);
    ...
    public void resetViews() {
        ...
        view = (TextView) findViewById(R.id.device_info);
        view.setText(R.string.empty);
        view = (TextView) findViewById(R.id.group_owner);
        view.setText(R.string.empty);
        view = (TextView) findViewById(R.id.status_text);
        view.setText(R.string.empty);
        findViewById(R.id.btn_start_client).setVisibility(View.GONE);
